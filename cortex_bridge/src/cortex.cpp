...
LOCAL unsigned short wCortexPort = 1025; // Cortex is listening at this port
LOCAL unsigned short wMultiCastPort = 1026; // Cortex sends frames to this port and associated address
...
LOCAL in_addr MyNicCardAddress = { (uint32_t)(10 << 24) + (1 << 16) + (2 << 8) + 199 }; // My local IP address
LOCAL in_addr MultiCastAddress = { (uint32_t)(225 << 24) + (1 << 16) + (1 << 8) + 1 }; // Cortex sends frames to this address and associated port

//LOCAL  in_addr CortexNicCardAddress={0,0,0,0};
//LOCAL  in_addr CortexNicCardAddress={255,255,255,255};
LOCAL in_addr CortexNicCardAddress = { (uint32_t)(255 << 24) + (255 << 16) + (255 << 8)
    + 255 };
